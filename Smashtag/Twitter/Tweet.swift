...
{
    public var text: String    // was let
    public var user: User    // was let
...
private extension NSString {
    func rangeOfString(substring: NSString, nearRange: NSRange) -> NSRange {
        ...
        var done = false
        while !done {
            let range = rangeOfString(substring as String, options: NSStringCompareOptions.allZeros, range: NSMakeRange(start, end-start))  // 'as String' was not present
